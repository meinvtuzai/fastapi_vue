...
@router.get("/hiker_rule_type", summary="搜索规则类型")
...
@router.get("/hiker_rule_type/{_id}", summary="通过ID获取规则类型")
async def getRecord(*,
                       db: Session = Depends(deps.get_db),
                       _id: int,
                       ):
...
@router.post("/hiker_rule_type", summary="添加规则类型")
async def addRecord(*,
                       db: Session = Depends(deps.get_db),
...
@router.put("/hiker_rule_type/{_id}", summary="修改规则类型")
async def setRecord(*,
                       db: Session = Depends(deps.get_db),
