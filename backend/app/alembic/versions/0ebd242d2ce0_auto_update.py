...
Revision ID: 0ebd242d2ce0
Revises: b5137859fd85
Create Date: 2023-12-04 20:59:20.511424
...
revision: str = '0ebd242d2ce0'
down_revision: Union[str, None] = 'b5137859fd85'
...
def upgrade() -> None:
    ...
    op.add_column('t_hiker_developer', sa.Column('test', sa.String(length=10), server_default=sa.text('null'), nullable=True, comment='测试字段'))
